...
if has("autocmd")
  ...
  autocmd BufWritePre *.rb,*.erb,*.html,*.js,*.css,*.php,*.py :call <SID>StripTrailingWhitespaces() " remove trailing white spaces before saving (only in specified filetypes)
endif
